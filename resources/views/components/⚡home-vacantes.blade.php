                ...
                @forelse ( $vacantes as $vacante )
                    <div class="md:flex md:justify-between md:items-center p-6">
                        ...
                        <div class="mt-5 md:mt-0">
                            <a href="{{ route('vacantes.show', $vacante->id) }}"
                                class="bg-indigo-500 text-white hover:bg-indigo-600 transition duration-200 p-3 text-sm uppercase font-bold rounded-lg block text-center">
                                Ver Vacante
                            </a>
                        </div>
                    </div>
